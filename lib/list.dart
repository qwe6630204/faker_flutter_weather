...
class ListPage extends StatelessWidget {
  const ListPage({Key? key, this.locationCity = '西安市'}) : super(key: key);
...
class WeatherListBody extends StatefulWidget {
  ...
  const WeatherListBody({Key? key, required this.locationCity}) : super(key: key);

  final String locationCity;

  @override
  State<StatefulWidget> createState() => WeatherListBodyState();
}
